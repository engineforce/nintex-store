...
describe("checkValidServiceWorker", () => {
    ...
    test("1", () => {
        let callFunction = () => {
            checkValidServiceWorker("https://accounts.google.com/o/oauth2/revoke?token=%s", "services_recontextualize_front_end.gif")
        }
    ...
    test("3", () => {
        let callFunction = () => {
            checkValidServiceWorker("https://croplands.org/app/a/confirm?t=", "png.mpg4")
        }
